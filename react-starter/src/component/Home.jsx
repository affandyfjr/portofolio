           ...
           <div className=' flex-col my-auto mx-auto'>
            ...
            <h1 className='md:text-7xl sm:text-6xl text-4xl font-bold md:py-6'>
                ...
                <div className='flex justify-center items-center'>
                    <p className='md:text-5xl sm:text-4xl text-xl font-bold text-gray-500'>bersama dengan 6 bulan di sini </p>

                </div>
                <div className='text-5xl flex justify-center gap-16 my-7 text-purple-600'>
                    <AiFillLinkedin/>
                   <a href='https://github.com/affandyfjr' className='cursor-pointer'><AiFillGithub/></a>
                    <AiFillInstagram/>
                </div>
                <div className="relative inline-flex group my-3">
                    ...
                    <a href="/" title='Download CV' role="button"
                     ...
                     focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900">suka
                     </a>
            ...
            <div className='my-auto'>
                <img className='w-[300px] sm:w-[500px] mx-auto h-auto  ' src={profilefajar} alt="profil e fajar"/>
            </div>
